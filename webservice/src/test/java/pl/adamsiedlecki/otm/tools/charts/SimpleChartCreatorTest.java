...
public class SimpleChartCreatorTest extends BaseSpringTest {
    ...
    public void shouldCreateChartUsingRandomDataWithRealDimensions() {
        //given
        List<TemperatureData> tempList = prepareRandomTemperatureDataList(4);
    ...
    public void shouldCreateChartFromFiveStationsUsingRandomDataWithRealDimensions() {
        ...
        //when
        File file = simpleChartCreator.createChart(tempList, config.getDefaultChartWidth(), config.getDefaultChartHeight(), "title of chart with data from 5 stations");
